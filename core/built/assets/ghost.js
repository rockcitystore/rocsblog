            ...
            doForgotten: function doForgotten(data, delay) {
                ...
                this.validate({ format: false }).then(function () {
                    ajax['default']({
                        ...
                        self.toggleProperty("submitting");
                        self.notifications.showAPIError(resp, { defaultErrorText: "登录时系统错误,请重试。" });
                    });
                    ...
                    if (invitedUser) {
                        ...
                        newUser.save().then(function () {
                            ...
                            if (newUser.get("status") === "invited-pending") {
                                self.notifications.showWarn("邀请邮件发送失败,请重试。");
                            } else {
        ...
        actions: {
            confirmAccept: function confirmAccept() {
                ...
                if (!transition || !editorController) {
                    ...
                    this.notifications.showError("对不起, 出现应用出错了，请联系我们修复。");
                    return true;
                }
    ...
    var child6 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.setAttribute(el3,"href","http://weibo.com/rockcitystore");
          dom.setAttribute(el3,"target","_blank");
          var el4 = dom.createElement("i");
          dom.setAttribute(el4,"class","icon-link");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode(" @辰曦 ");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n\n                ");
        ...
        //  dom.appendChild(el3, el4);
         // dom.appendChild(el2, el3);
          ...
          dom.setAttribute(el3,"role","menuitem");
          dom.setAttribute(el3,"tabindex","-1");
          dom.setAttribute(el3,"href","http://rocs.aliapp.com/welcome/");
          dom.setAttribute(el3,"target","_blank");
          var el4 = dom.createElement("i");
          dom.setAttribute(el4,"class","icon-book");
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode(" 使用指引 ");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n\n                ");
            ...
            var child0 = (function() {
              return {
                ...
                build: function build(dom) {
                  ...
                  var el2 = dom.createTextNode("static page");
                  dom.appendChild(el1, el2);
                  dom.appendChild(el0, el1);
                  var el1 = dom.createTextNode("\n");
                  dom.appendChild(el0, el1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("p");
          var el2 = dom.createTextNode("Just a Blogging Platform.");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el5,"href","https://github.com/TryGhost/");
        ...
        var el4 = dom.createTextNode("Ghost的开发者来自全球各地，这里列出的是主要开发者。");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("h1");
        var el4 = dom.createTextNode("About Ghost");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n       \n        ");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el5,"src","https://avatars3.githubusercontent.com/u/2178663?v=3&s=200");
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("p");
        var el4 = dom.createTextNode("Ghost is a platform dedicated to one thing: Publishing. It's beautifully designed, completely customisable and completely Open Source. Ghost allows you to write and publish your own blog, giving you the tools to make it easy and even fun to do. ");
        dom.appendChild(el3, el4);
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"target","_blank");
        dom.setAttribute(el4,"href","http://weibo.com/rockcitystore");
        dom.setAttribute(el4,"title","@辰曦");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"src","");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("h1");
        var el6 = dom.createTextNode("欢迎，我的朋友");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        if (request.status !== 200) {
            try {
                ...
                if (request.responseJSON.errors && Ember['default'].isArray(request.responseJSON.errors)) {
                    ...
                    message = request.responseJSON.error || "未知错误";
                }
            } catch (e) {
                msgDetail = request.status ? request.status + " - " + request.statusText : "服务器挂了";
                message = "服务返回错误 (" + msgDetail + ")。";
            }
        }
...
define('ghost/utils/notifications', ['exports', 'ember', 'ghost/models/notification'], function (exports, Ember, Notification) {
    ...
    var Notifications = Ember['default'].ArrayProxy.extend({
        ...
        showAPIError: function showAPIError(resp, options) {
            ...
            options.defaultErrorText = options.defaultErrorText || "服务器出错了，请重试。";
